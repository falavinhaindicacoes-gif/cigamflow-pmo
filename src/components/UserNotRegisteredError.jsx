      ...
      <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-lg border border-slate-100">
        <div className="text-center">
          ...
          <div className="p-4 bg-slate-50 rounded-md text-sm text-slate-600 mb-6">
            <p>Se acredita que isso é um erro:</p>
          ...
          <button
            ...
            className="w-full py-2 px-4 bg-slate-800 text-white rounded-md text-sm font-medium hover:bg-slate-700 transition-colors"
          >
